...
import { FaUserGraduate, FaBriefcase, FaBullseye } from "react-icons/fa6";
import { MdOutlineHealthAndSafety } from "react-icons/md";

// Asset import - verification standard
import profile from "../../assets/welcome.jpg";

// Explicit Motion Curve Presets
...
const AboutMpLanding = () => {
  ...
  return (
    <section className="relative overflow-hidden py-16 sm:py-20 lg:py-28 bg-slate-50 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 relative z-10">
        ...
        >
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-100/80 text-emerald-800 font-semibold text-xs sm:text-sm border border-emerald-300/40">
            ...
            Official Profile: Dr. Mahbubur Rahman Liton
          </span>

          <h1 className="mt-4 text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 leading-tight tracking-tight">
          ...
          <p className="mt-4 sm:mt-6 text-base sm:text-lg text-slate-600 leading-relaxed">
            ...
            building a healthier, stronger, and digitized constituency.
          </p>
        </motion.div>

        {/* Layout Column Matrix */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          
          {/* Left Column Profile Framework */}
          <motion.div
          ...
          >
            <div className="relative">
              <div className="relative overflow-hidden rounded-3xl shadow-2xl border border-slate-200/80 bg-white group">
                <img
                  src={profile}
                  alt="Dr. Mahbubur Rahman Liton, MP for Trishal"
            ...
            {/* Micro-Stats Component Elements */}
          ...
          {/* Right Column Timeline Mapping Component */}
          <motion.div
              ...
              {timeline.map((item, index) => (
                ...
                >
                  ...
                  <div className="flex-1 bg-white/90 backdrop-blur-md rounded-2xl p-6 sm:p-8 shadow-md border border-slate-200/80 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:border-emerald-300/60">
                    ...
                    <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mt-1 mb-3">
                      {item.title}
                    </h2>
