...
import AboutMpLanding from "./components/AboutMp/AboutMpLanding";
import { AboutMpTrigger } from "./components/AboutMp/AboutMP";
import Contact from "./components/Contact/Contact";

// Inline scroll tracking component to handle path transitions smoothly
const ScrollToTop = () => {
  ...
  useEffect(() => {
    window.scrollTo({
      top: 0,
      left: 0,
      behavior: "smooth", // Animates the viewport scrolling upward elegantly
    });
  }, [pathname]);
...
function App() {
  ...
  return (
    <div className="relative">
      ...
      {/* Automates screen scroll resets back to start point on every path change */}
      <ScrollToTop />
      ...
      <Routes>
        ...
        <Route path="/about" element={<AboutMpLanding />}></Route>
